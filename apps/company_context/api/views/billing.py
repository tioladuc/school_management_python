...
class CompanyBillingHistoryView(APIView):
    def get(self,request,company_id): return Response(ContractDataResponseSerializer(services()['billing'].history(GetBillingHistoryQuery(company_id)),many=True).data)
